...
from muon_tools.aiida_muon.distortions import get_struct_wt_distortions
...
# %%
def get_clustering_after_run_from_data(
    data, 
    input_st, 
    sc_matrix, 
    magmom=None
    ...
    return analyze_structures(init_supc, data, input_st, magmom)